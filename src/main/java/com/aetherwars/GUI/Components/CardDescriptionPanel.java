...
public class CardDescriptionPanel extends JPanel {
    ...
    public CardDescriptionPanel(Character chara){
      ...
      // this.setPreferredSize(new java.awt.Dimension(200, 123));
        //gambar kartu
        String informationtext = "<html><h1>"+chara.getName()+"</h1><p>ATK : "+chara.getAttack()+
                "</p><p>HP : "+chara.getHealth()+"</p><p>Level : "+chara.getLevel()+"</p><p>EXP: "+
                chara.getExp()+"/"+chara.getMaxExpToNextLevel()+"</p><p>Type : "+chara.getType()+
                "</p></html>";
        this.information = new JLabel(informationtext);
        this.description = new JLabel("<html><p>\""+chara.getDescription()+"\"</p></html>");
